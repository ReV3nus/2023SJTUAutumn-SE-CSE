...
TEST_F(RaftTestPart1, LeaderElection)
{
  ...
  EXPECT_GE(CheckOneLeader(), 0);
  std::cout<<"ALLFINISH"<<std::endl;
}

TEST_F(RaftTestPart1, ReElection)
{
  std::cout<<"SECONDSTARTING"<<std::endl;
  InitNodes(5);

  /* 1. check one leader */
  mssleep(300);
  // std::cout<<"CHEKINGONELEADER"<<std::endl;
  int leader1 = CheckOneLeader();

  /* 2. stop the leader */
  // std::cout<<"DISABLEDFIRST"<<std::endl;
  DisableNode(leader1);
  mssleep(1000);

  // std::cout<<"CHEKINGONELEADER2"<<std::endl;
  ...
  // std::cout<<"DISABLEDSECOND"<<std::endl;
  DisableNode(leader2);
  mssleep(1000);

  // std::cout<<"CHEKINGONELEADER3"<<std::endl;
  ...
  // std::cout<<"DISABLEDTHIRD"<<std::endl;
  DisableNode(leader3);
  mssleep(1000);

  /* 5. only 2 nodes left with no leader */
  // std::cout<<"CHECKINGNOLEADER"<<std::endl;
  CheckNoLeader();

  /* 6. resume a node */
  // std::cout<<"ENABLELEADER"<<std::endl;
  EnableNode(leader1);
  mssleep(1000);
  // std::cout<<"CHEKINGONELEADER4"<<std::endl;
  CheckOneLeader();
}
