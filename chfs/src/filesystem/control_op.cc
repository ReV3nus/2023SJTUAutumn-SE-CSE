...
// std::cout<<"$$$$ read inode error! "<<id<<std::endl;
    goto err_ret;
  }
...
// std::cout<<"$$$$ read block error! "<<std::endl;
      goto err_ret;
    }
...
// std::cout<<"$$$$ free inode error! "<<id<<std::endl;
      goto err_ret;
    }
  ...
  for (auto bid : free_set) {
    ...
    if (res.is_err()) {
// std::cout<<"$$$$ deallocate block error! "<<bid<<std::endl;
      return res;
    }
  }
  return KNullOk;
